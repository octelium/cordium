    ...
    <PageWrap qry={ctx.space}>
      ...
      <div>
        <div>
          ...
          <BoxItem title="General Info">
            {data.status?.type === Space_Status_Type.ORGANIZATION && (
              <InfoItem title="Name">{data.metadata?.name}</InfoItem>
            )}
          ...
          */}
          ...
          <BoxItem title="Links">
              <div className="flex items-center">
                {qryEnvironment.isSuccess &&
                  qryEnvironment.data.listResponseMeta && (
                    <Button
                      size="small"
                      mode="outline"
                      item
                      onClick={() => {
                        navigate(
                          `/environments?spaceUID=${data.metadata?.uid}`
                        );
                      }}
                    >
                      Environments{" "}
                      <Label>
                        {qryEnvironment.data.listResponseMeta.totalCount}
                      </Label>
                    </Button>
                  )}
                ...
                {isAdmin && <ResourceYAML item={data} btnItem />}
                ...
                {isAdmin &&
                  ...
                  qrySecret.data.listResponseMeta && (
                    <Button
                      ...
                      item
                      onClick={() => {
                        navigate(`/secrets?spaceUID=${data.metadata?.uid}`);
                      }}
                    >
                      Secrets
                      <Label>
                        {qrySecret.data.listResponseMeta.totalCount}
                      </Label>
                    </Button>
                  )}

                {qryMemberships.isSuccess &&
                  qryMemberships.data.listResponseMeta && (
                    <Button
                      size="small"
                      mode="outline"
                      item
                      onClick={() => {
                        navigate(`/memberships?spaceUID=${uid}`);
                      }}
                    >
                      Members{" "}
                      <Label>
                        {qryMemberships.data.listResponseMeta.totalCount}
                      </Label>
                    </Button>
                  )}
                ...
                {isOrg &&
                  ...
                  qryGitProvider.data.listResponseMeta && (
                    <Button
                      ...
                      item
                      onClick={() => {
                        navigate(`/gitproviders?spaceUID=${uid}`);
                      }}
                    >
                      Git Providers
                      <Label>
                        {qryGitProvider.data.listResponseMeta.totalCount}
                      </Label>
                    </Button>
                  )}
              </div>
