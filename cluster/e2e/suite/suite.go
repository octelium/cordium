...
func Phases() []suite.Phase {
	return []suite.Phase{
		...
		{Name: "WorkspaceNetworkValidation", Run: testWorkspaceNetworkValidation},
		...
		{Name: "WorkspaceSandbox", Run: testWorkspaceSandbox},
		{Name: "WorkspaceContainer", Run: testWorkspaceContainer},
		{Name: "WorkspaceFilesystem", Run: testWorkspaceFilesystem},
		{Name: "WorkspaceNetwork", Run: testWorkspaceNetwork},
		{Name: "WorkspaceNetworkPolicy", Run: testWorkspaceNetworkPolicy},
		{Name: "WorkspaceTemplateMerge", Run: testWorkspaceTemplateMerge},
		{Name: "WorkspaceTasks", Run: testWorkspaceTasks},
		{Name: "WorkspaceTaskFailure", Run: testWorkspaceTaskFailure},
		...
		{Name: "WorkspaceVolume", Run: testWorkspaceVolume},
